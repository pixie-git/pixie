      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-wrapper">
            <div class="left-col">
                ...
                <div class="form-group" v-if="form.palette === 'custom'">
                    <label>Custom Hex Codes</label>
                    <textarea 
                      v-model="form.customPalette" 
                      placeholder="#FFFFFF, #000000..." 
                      class="custom-palette-input"
                    ></textarea>
                    <small>Separate with commas or newlines</small>
                </div>
            </div>
...
const validateHexArray = (input: string): string[] | null => {
